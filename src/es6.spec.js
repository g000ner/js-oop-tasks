...
describe('es6', () => {
    ...
    describe('#Dictionary', () => {
        ...
        it('добавляет слова', () => {
            ...
            dic.add(
                'Lorem Ipsum',
                'текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века'
            );
            dic.add(
                'Мем',
                'Единица значимой для культуры информации. Мемом является любая идея, символ, манера, ситуация или образ действия, осознанно или неосознанно передаваемые от человека к человеку посредством речи, письма, видео, ритуалов, жестов и т. д.'
            );
            assert.strictEqual(dic.view('Мем'), 
        ...
        it('удаляет слова', () => {
            ...
            dic.delete('Мем')
            assert.strictEqual(dic.view('Мем'), 'no word Мем founded in the dictionary');
        });

        it('приводится к строке', () => {
            const dic = new core.Dictionary();
            dic.add(
                'Lorem Ipsum',
                'текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века'
